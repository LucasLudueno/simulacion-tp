...
print("Tiempo medio para opcion DB distribuida: ", float(wating_time_distributed)  / CANTIDAD_MUESTRAS)
print("Tiempo medio para opcion DB centralizada: ", float(wating_time_centralized) / CANTIDAD_MUESTRAS)
